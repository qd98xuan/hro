...
//                    qyDeptList = JsonUtil.createJsonToList(deptObject.getString("department"), QyWebChatDeptModel.class);
//                }else{
...
//    }
     ...
     */
    @Override
    public JSONObject createDepartmentSysToQy(boolean isBatch, SysOrganizeEntity deptEntity, String accessToken) throws WxErrorException {
        BaseSystemInfo config = getQyhConfig();
        String corpId = config.getQyhCorpId();
...
//                }
     ...
     */
    @Override
    public JSONObject updateDepartmentSysToQy(boolean isBatch, SysOrganizeEntity deptEntity, String accessToken) throws WxErrorException {
        BaseSystemInfo config = getQyhConfig();
        String corpId = config.getQyhCorpId();
        // 向企业微信插入数据需要另外token（凭证密钥）
        String corpSecret = config.getQyhAgentSecret();
    ...
    public QyWebChatUserModel getQyUserById(String id, String accessToken) throws WxErrorException {
        ...
        if(userObject.getBoolean("code")) {
            userModel = JsonUtil.createJsonToBean(userObject.getString("userinfo"), QyWebChatUserModel.class);
        }
        return userModel;
    }
...
//    }
     ...
     * @return
     */
    public JSONObject setQyUserObject(SysUserEntity userEntity, QyWebChatUserModel qyWebChatUserModel) {
...
//                    if(userObject.getBoolean("code")) {
//                        qyUserList = JsonUtil.createJsonToList(userObject.getString("userlist"), QyWebChatUserModel.class);
//                    }else{
//                        synState = SynThirdConsts.SYN_STATE_FAIL;
...
//    }
     ...
     */
    @Override
    public JSONObject createUserSysToQy(boolean isBatch, SysUserEntity userEntity, String accessToken) throws WxErrorException {
        BaseSystemInfo config = getQyhConfig();
        String corpId = config.getQyhCorpId();
        // 向企业微信插入数据需要另外token（凭证密钥）
        String corpSecret = config.getQyhAgentSecret();
     ...
     */
    @Override
    public JSONObject updateUserSysToQy(boolean isBatch, SysUserEntity userEntity, String accessToken) throws WxErrorException {
        BaseSystemInfo config = getQyhConfig();
        String corpId = config.getQyhCorpId();
        // 向企业微信插入数据需要另外token（凭证密钥）
        String corpSecret = config.getQyhAgentSecret();
