...
import com.linzen.model.form.MultipleControlEnum;
...
public class FormPublicUtils {
    ...
    public static List<FieLdsModel> recursionFields(List<TableModel> tableModels, List<FieLdsModel> fieLdsModelList) {
        ...
        childTable.stream().forEach(formModel -> {
            String projectKey = formModel.getProjectKey();
            ...
            configModel.setProjectKey(projectKey);
     ...
     * @return
     */
    public static boolean dateTimeCondition(FieLdsModel swapDataVo, String format, Object value, Map<String, Object> data, String projectKey) {
        long valueTimeLong;
        //输入值转long
        ...
        if ((swapDataVo.getConfig().getStartTimeRule() && StringUtil.isNotEmpty(swapDataVo.getConfig().getStartTimeValue()))
            ...
            //根据类型获取开始时间戳
            long startTimeLong = getDateTimeLong(data, projectKey, startTimeValue, startTimeType, startTimeTarget, startTimeRelationField);
        ...
        if ((swapDataVo.getConfig().getEndTimeRule() && StringUtil.isNotEmpty(swapDataVo.getConfig().getEndTimeValue()))
            ...
            //根据类型获取开始时间戳
            long endTimeLong = getDateTimeLong(data, projectKey, endTimeValue, endTimeType, endTimeTarget, endTimeRelationField);
     ...
     * @return
     */
    private static long getDateTimeLong(Map<String, Object> data, String projectKey, String timeValue, String timeType, String timeTarget,
        ...
        switch (timeType) {
            ...
            case "2"://表单字段
                if (stringimeRelationField != null) {
                    String fieldValue = "";
                    if (stringimeRelationField.toLowerCase().contains(ProjectKeyConsts.CHILD_TABLE_PREFIX)) {//子
