...
public class AuthSocialsUtil {
    ...
    public AuthRequest getAuthRequest(String source, String userId, boolean isLogin, String ticket, String tenantId) {
        ...
        String addUrlStr = "";
        String urlStr = oauthConfig.getLinzenDomain() + "/api/oauth/Login/socials?source=" + source;
        if (!isLogin) {
            urlStr = oauthConfig.getLinzenDomain() + "/api/oauth/Login/socials?source=" + source;
        }
        if (StringUtil.isNotEmpty(userId)) {
            addUrlStr = "&userId=" + userId;
        }
        if (StringUtil.isNotEmpty(ticket)) {
            addUrlStr = "&linzen_ticket=" + ticket;
        }
