...
import com.linzen.visualdata.model.visualglob.*;
...
public class VisualGlobController extends SuperController<VisualGlobService, VisualGlobEntity> {
    ...
    @GetMapping("/list")
    public ServiceResult<VisualPageVO<VisualGlobListVO>> list(VisualGlobPaginationModel pagination) {
        List<VisualGlobEntity> data = gloService.getList(pagination);
        List<VisualGlobListVO> list = JsonUtil.createJsonToList(data, VisualGlobListVO.class);
    ...
    public ServiceResult<VisualGlobInfoVO> info(@RequestParam("id")String id) {
        VisualGlobEntity entity = gloService.getInfo(id);
        VisualGlobInfoVO vo = BeanUtil.toBean(entity, VisualGlobInfoVO.class);
    ...
    @SaCheckPermission("onlineDev.dataScreen")
    public ServiceResult create(@RequestBody VisualGlobCrForm recordCrForm) {
        VisualGlobEntity entity = BeanUtil.toBean(recordCrForm, VisualGlobEntity.class);
    ...
    @SaCheckPermission("onlineDev.dataScreen")
    public ServiceResult update(@RequestBody VisualGlobUpForm recordUpForm) {
        VisualGlobEntity entity = BeanUtil.toBean(recordUpForm, VisualGlobEntity.class);
