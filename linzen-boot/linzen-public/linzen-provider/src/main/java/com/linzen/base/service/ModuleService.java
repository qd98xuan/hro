...
public interface ModuleService extends SuperService<ModuleEntity> {
     ...
     * @return ignore
     */
    List<ModuleEntity> getList(String systemId, String category, String keyword, Integer type, Integer delFlag, String parentId, boolean release);
     ...
     */
    ServiceResult importData(ModuleExportModel exportModel, Integer type) throws DataBaseException;
