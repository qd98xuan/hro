...
public class FileReportProvider implements ReportProvider,ApplicationContextAware{
	...
	public InputStream loadReport(String file) {
		...
		try {
			return new FileInputStream(XSSEscape.escapePath(fullPath));
	...
	public void deleteReport(String file) {
		...
		String fullPath=fileStoreDir+"/"+file;
		File f=new File(XSSEscape.escapePath(fullPath));
		if(f.exists()){
			f.delete();
		}
	}
	...
	public List<ReportFile> getReportFiles() {
		File file=new File(XSSEscape.escapePath(fileStoreDir));
	...
	public void saveReport(String file,String content) {
		...
		try{
			outStream=new FileOutputStream(XSSEscape.escapePath(fullPath));
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		if(applicationContext instanceof WebApplicationContext){
			...
			file=new File(XSSEscape.escapePath(fileStoreDir));
			if(!file.exists()){
				file.mkdirs();
			}
		}
