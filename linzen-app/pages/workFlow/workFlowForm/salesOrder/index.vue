<template>
	<view class="linzen-wrap linzen-wrap-workflow">
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-position="left"
			...
			<view class="linzen-card">
				<view class="u-p-l-20 u-p-r-20 form-item-box">
					...
					<u-form-item label="开单日期" prop="salesDate" v-if="judgeShow('salesDate')"
						...
						<linzen-date-time type="datetime" v-model="dataForm.salesDate" placeholder="请输入开单日期"
							:disabled="judgeWrite('salesDate')"></linzen-date-time>
					</u-form-item>
					...
					<u-form-item label="发票类型" prop="invoiceType" v-if="judgeShow('invoiceType')"
						...
						<linzen-select v-model="dataForm.invoiceType" placeholder="请选择发票类型" :options="invoiceTypeList"
							:disabled="judgeWrite('invoiceType')"></linzen-select>
					</u-form-item>
			...
			<view class="linzen-table" v-if="judgeShow('entryList')">
				<view class="linzen-table-item" v-for="(item,i) in dataForm.entryList" :key="i">
					<view class="linzen-table-item-title u-flex u-row-between">
						<text class="linzen-table-item-title-num">销售明细({{i+1}})</text>
					...
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						...
						<u-form-item label="金额" prop="dataForm.entryList[i].amount" v-if="judgeShow('entryList-amount')"
							...
							<u-input v-model="dataForm.entryList[i].amount" placeholder="请输入金额" disabled
								input-align="right"></u-input>
						</u-form-item>
				...
				<view class="linzen-table-addBtn" @click="addItem" v-if="!judgeWrite('entryList')">
