				...
				<scroll-view :scroll-y="true" style="height: 550rpx;" class="scroll_view">
					<view class="comment-area">
						...
						<view v-for='(item,index) in dataForm.file' :key="index"
							class="linzen-file-item u-type-primary u-flex u-line-1" @tap='downLoad(item)'>
							<view class="linzen-file-item-txt u-line-1">{{item.name}}</view>
							<!-- #ifndef MP-WEIXIN -->
				...
				<view class="btn_box">
					<u-upload :custom-btn="true" :action="comUploadUrl+type" :header="uploadHeaders" ref="uUpload"
						...
						<view slot="addBtn" class="slot-btn" hover-class="slot-btn__hover" hover-stay-time="150">
							<view class="zen-custom zen-custom-image img_icon"></view>
						</view>
					</u-upload>
					<fileComment ref="lsjUpload" width="100px" height="80rpx" childId="upload" :size="10"
						:option="option" v-model="percent" @callback="onCallback">
						<view class="icon-zen icon-zen-h5 file_icon" size="mini">
						</view>
					</fileComment>
				</view>
			</view>
...
<script>
	...
	import fileComment from './file-comment/index.vue'
	export default {
		components: {
			fileComment
		},
