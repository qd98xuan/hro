		...
		<view style="background-color: #fff;" class="u-p-l-20 u-p-r-20">
			<u-form :model="dataForm" :errorType="['toast']" label-position="left" label-width="150" label-align="right"
				...
				<u-form-item label="民族">
					<linzen-select v-model="dataForm.nation" placeholder="请选择我的民族" :options='nationOptions'>
					</linzen-select>
				</u-form-item>
				<u-form-item label="性别">
					<linzen-select v-model="dataForm.gender" placeholder="请选择我的性别" :options='genderOptions'
						:props='props'>
					</linzen-select>
				</u-form-item>
				...
				<u-form-item label="证件类型">
					<linzen-select v-model="dataForm.certificatesType" placeholder="请选择证件类型"
						:options='certificatesTypeOptions'>
					</linzen-select>
				</u-form-item>
				<u-form-item label="证件号码">
					<u-input input-align='right' v-model="dataForm.certificatesNumber" placeholder="请输入证件号码">
					</u-input>
				</u-form-item>
				<u-form-item label="文化程度">
					<linzen-select v-model="dataForm.education" placeholder="请选择文化程度" :options='educationOptions'>
					</linzen-select>
				</u-form-item>
				<u-form-item label="出生年月">
					<linzen-date-time type="date" v-model="dataForm.birthday" placeholder="请选择出生年月">
					</linzen-date-time>
				</u-form-item>
				...
				<u-form-item label="紧急联系">
					<u-input input-align='right' v-model="dataForm.urgentContacts" placeholder="请输入紧急联系">
					</u-input>
				</u-form-item>
