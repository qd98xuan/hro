<template>
	<view class="linzen-tree-select">
		<u-input type="select" input-align='right' :select-open="selectShow" v-model="innerValue"
		...
		<tree-select v-model="selectShow" @confirm="selectConfirm" :default-value="defaultValue" :options="options"
			...
			:props="props" :filterable="filterable">
		</tree-select>
	</view>
</template>
