...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'LinzenRadio', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...unref(attrs),
    class: unref(attrs).class ? `linzen-${props.direction}-radio ${unref(attrs).class}` : `linzen-${props.direction}-radio`,
  }));
