...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'LinzenCheckbox', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...unref(attrs),
    class: unref(attrs).class ? `linzen-${props.direction}-checkbox ${unref(attrs).class}` : `linzen-${props.direction}-checkbox`,
  }));
