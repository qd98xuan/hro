<template>
  <TreeSelect class="linzen-tree-select" v-bind="getBindValue" v-model:value="innerValue" @change="onChange">
    <template #title="data">
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'LinzenTreeSelect', inheritAttrs: false });
