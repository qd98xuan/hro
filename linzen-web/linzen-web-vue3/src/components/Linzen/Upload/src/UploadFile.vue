<template>
  <div class="upload-file-container" :class="$attrs.class">
    <template v-if="!detailed">
      <a-button preIcon="icon-linzen icon-linzen-btn-upload" :disabled="disabled" @click="uploadFile">{{ buttonText }}</a-button>
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'LinzenUploadFile', inheritAttrs: false });
