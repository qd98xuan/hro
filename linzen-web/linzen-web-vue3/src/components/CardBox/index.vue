...
<!--      <a-badge-ribbon>-->
<!--        <template #text>-->
<!--          <BadgeStatus :status="status" :text="statusText" :statusNames="statusNames"></BadgeStatus>-->
<!--        </template>-->
<!--        <a-card size="small" style="background-color: #f0f0f0">-->
<!--          <template #title>-->
<!--            <a-badge/>-->
<!--            <span><slot name="titleName"></slot></span>-->
<!--          </template>-->
<!--        </a-card>-->
<!--      </a-badge-ribbon>-->
<!--    </div>-->
    ...
    >
      ...
      >
        <div
            ...
            :style="{background: getBackgroundColor(statusNames[status]),}"
        ></div>
        <div
        ...
        <div v-if="active" class="checked-icon">
          <div>
            <LinzenAIcon type="CheckOutlined"/>
          </div>
        </div>

        <!-- 状态 -->
        <div v-if="showStatus" class="card-state" :style="{ backgroundColor: getHexColor(statusNames[status]), }" >
