<template>
  <a-collapse-panel key="1">
    ...
    <a-form-item v-if="!noStyleTypeList.includes(activeData.projectKey)">
      <template #label>风格类型<BasicHelp v-if="!!getTipLabel()" :text="getTipLabel()" /></template>
      <linzen-select v-model:value="activeData.option.styleType" :options="getStyleTypeOptions" placeholder="请选择" showSearch @change="onStyleTypeChange" />
    </a-form-item>
    <template v-if="activeData.projectKey == 'lineChart'">
    ...
    <template v-if="activeData.projectKey == 'pieChart'">
    ...
    <template v-if="activeData.projectKey == 'radarChart'">
    ...
    <template v-if="activeData.projectKey == 'rankList'">
      ...
      <div class="options-list">
        ...
        <div class="add-btn">
          <a-button type="link" preIcon="icon-linzen icon-linzen-btn-add" @click="addSelectItem">添加字段</a-button>
        </div>
      </div>
    </template>
    <template v-if="activeData.projectKey == 'timeAxis'">
      <a-form-item>
        <template #label>标签布局<BasicHelp text="APP不支持所有交错类型，默认显示轴右侧" /></template>
        <linzen-select v-model:value="activeData.option.layout" :options="layoutStyleList" placeholder="请选择" showSearch />
      </a-form-item>
      <a-form-item label="排序">
        <linzen-radio v-model:value="activeData.option.sortable" :options="sortList" optionType="button" buttonStyle="solid" />
      </a-form-item>
      <a-form-item label="显示条数">
        <a-input-number v-model:value="activeData.option.showNumber" min="0" :max="50" v-if="showType == 'pc'" />
        <a-input-number v-model:value="activeData.option.appShowNumber" min="0" :max="50" v-else />
      </a-form-item>
    </template>
    <template v-if="activeData.projectKey == 'text'">
      <a-form-item label="文本类型">
        <linzen-radio v-model:value="activeData.option.styleType" :options="textStyleList" optionType="button" buttonStyle="solid" @change="textChange" />
      </a-form-item>
      <a-form-item label="数据类型">
        <linzen-radio v-model:value="activeData.dataType" :options="dataTypeList" optionType="button" buttonStyle="solid" @change="dataTypeChange" />
      </a-form-item>
      ...
      <template v-if="activeData.option.styleType != 2">
        <a-form-item label="文本大小">
          <a-input-number v-model:value="activeData.option.textFontSize" :min="12" :max="25" />
        </a-form-item>
        ...
        <a-form-item label="文本颜色">
          <linzen-color-picker v-model:value="activeData.option.textFontColor" size="small" />
        </a-form-item>
        <a-form-item label="文本位置">
          <linzen-radio v-model:value="activeData.option.textLeft" :options="alignList" optionType="button" buttonStyle="solid" class="right-radio" />
        </a-form-item>
        <a-form-item label="文本下划线">
          <linzen-radio v-model:value="activeData.option.textUnderLine" :options="underLineList" optionType="button" buttonStyle="solid" />
        </a-form-item>
      </template>
      ...
      <a-form-item label="背景色">
        <linzen-color-picker v-model:value="activeData.option.textBgColor" size="small" />
      </a-form-item>
      <Link :activeData="activeData" :menuList="menuList" :appMenuList="appMenuList" :showType="showType" />
    </template>
    <template v-if="activeData.projectKey == 'image'">
      ...
      <a-form-item label="上传图片" v-if="activeData.option.styleType == 1">
        <LinzenUploadImgSingle v-model:value="activeData.option.defaultValue" />
      </a-form-item>
      ...
      <a-form-item label="填充方式">
        <linzen-select v-model:value="activeData.option.imageFillStyle" :options="fillStyleList" placeholder="请选择" showSearch />
      </a-form-item>
    ...
    <template v-if="activeData.projectKey == 'carousel'">
      ...
      <template v-if="showType == 'pc'">
        <a-form-item label="箭头显示" v-if="activeData.option.carouselDirection == 'horizontal'">
          <linzen-radio v-model:value="activeData.option.carouselArrow" :options="arrowList" optionType="button" buttonStyle="solid" />
        </a-form-item>
      </template>
    ...
    <template v-if="activeData.projectKey == 'video'">
      ...
      <a-form-item label="上传视频" v-if="activeData.option.styleType == '1'">
        <LinzenUploadFile v-model:value="fileList" :limit="1" buttonText="上传视频" accept="video/*" fileSize="100" @change="onUploadFileChange" />
      </a-form-item>
      <a-form-item v-else-if="activeData.option.styleType == 2">
      ...
      <a-form-item label="播放频率">
        <linzen-radio v-model:value="activeData.option.playNumber" :options="playNumberList" optionType="button" buttonStyle="solid" class="right-radio-more" />
      </a-form-item>
      <a-form-item label="静音播放">
        <a-switch v-model:checked="activeData.option.mutePlay" />
      </a-form-item>
    </template>
    <template v-if="activeData.projectKey == 'iframe'">
      <a-form-item>
        <template #label>链接地址<BasicHelp text="地址以http://或https://为开头" /></template>
        <a-input v-model:value="activeData.option.defaultValue" placeholder="请输入" />
      </a-form-item>
    </template>
    <template v-if="activeData.projectKey == 'todo'">
      <template v-if="showType == 'app'">
        <a-form-item label="风格类型">
          <linzen-select v-model:value="activeData.option.styleType" :options="appTodoStyleList" placeholder="请选择" showSearch />
        </a-form-item>
        <template v-if="activeData.option.styleType == 2">
          <a-form-item label="每行选项数">
            <a-input-number v-model:value="activeData.option.appRowNumber" :min="1" :max="10" />
          </a-form-item>
      ...
      <template v-else>
        <a-form-item label="每行选项数">
          <a-input-number v-model:value="activeData.option.rowNumber" :min="1" :max="10" />
        </a-form-item>
        <a-form-item label="显示边框">
      ...
      <a-form-item label="名称大小">
        <a-input-number v-model:value="activeData.option.labelFontSize" :min="12" :max="25" />
      </a-form-item>
      <a-form-item label="名称加粗">
        <a-switch v-model:checked="activeData.option.labelFontWeight" />
      </a-form-item>
      <a-form-item label="名称颜色">
        <linzen-color-picker v-model:value="activeData.option.labelFontColor" size="small" />
      </a-form-item>
      <a-form-item label="数值大小">
        <a-input-number v-model:value="activeData.option.valueFontSize" :min="12" :max="25" />
      </a-form-item>
      <a-form-item label="数值加粗">
        <a-switch v-model:checked="activeData.option.valueFontWeight" />
      </a-form-item>
      <a-form-item label="数值颜色">
        <linzen-color-picker v-model:value="activeData.option.valueFontColor" size="small" />
      </a-form-item>
      <a-form-item label="数值背景色" v-if="showType == 'app'">
        <linzen-color-picker v-model:value="activeData.option.valueFontBgColor" size="small" />
      </a-form-item>
    </template>
    <template v-if="activeData.projectKey == 'commonFunc'">
      <template v-if="showType == 'app'">
        <a-form-item label="风格类型">
          <linzen-select v-model:value="activeData.option.appStyleType" :options="appTodoStyleList" placeholder="请选择" showSearch />
        </a-form-item>
      ...
      <a-form-item label="图标位置" v-if="showType == 'pc'">
        <linzen-radio v-model:value="activeData.option.styleType" :options="commonFuncStyleList" optionType="button" buttonStyle="solid" />
      </a-form-item>
      <a-form-item label="名称大小">
        <a-input-number v-model:value="activeData.option.labelFontSize" :min="12" :max="25" />
      </a-form-item>
    ...
    <template v-if="activeData.projectKey == 'dataBoard'">
      <template v-if="showType == 'app'">
        <a-form-item label="风格类型">
          <linzen-select v-model:value="activeData.option.appStyleType" :options="appTodoStyleList" placeholder="请选择" showSearch />
        </a-form-item>
      ...
      <a-form-item label="数据类型">
        <linzen-radio v-model:value="activeData.dataType" :options="dataTypeList" optionType="button" button-style="solid" @change="dataBoardDataTypeChange" />
      </a-form-item>
      <a-form-item label="数据接口" v-if="activeData.dataType === 'dynamic'">
        <interface-modal :value="activeData.propsApi" :title="activeData.propsName" popupTitle="数据接口" @change="onPropsApiChange" />
      </a-form-item>
      <Refresh :refresh="activeData.refresh" v-if="activeData.dataType === 'dynamic'" />
      <a-form-item label="选项">
      ...
      <a-form-item label="单位大小">
        <a-input-number v-model:value="activeData.option.unitFontSize" :min="12" :max="25" />
      </a-form-item>
      <a-form-item label="单位加粗">
        <a-switch v-model:checked="activeData.option.unitFontWeight" />
      </a-form-item>
      <a-form-item label="单位颜色">
        <linzen-color-picker v-model:value="activeData.option.unitFontColor" size="small" />
      </a-form-item>
    </template>
...
<script lang="ts" setup>
  ...
  const getStyleTypeOptions = computed(() => {
    const projectKey = props.activeData.projectKey;
    if (projectKey == 'barChart') return JSON.parse(JSON.stringify(barStyleList));
    if (projectKey == 'lineChart') return lineStyleList;
    if (projectKey == 'pieChart') return pieStyleList;
    if (projectKey == 'radarChart') return radarStyleList;
    if (projectKey == 'rankList') return rankStyleList;
    if (projectKey == 'timeAxis') return timeStyleList;
    if (projectKey == 'image') return imageStyleList;
    if (projectKey == 'video') return videoStyleList;
    if (projectKey == 'mapChart') return mapStyleList;
  });
  ...
  function getTitle() {
    const projectKey = props.activeData.projectKey;
    if (projectKey == 'barChart') return '柱状图设置';
    if (projectKey == 'lineChart') return '折线图设置';
    if (projectKey == 'pieChart') return '饼图设置';
    if (projectKey == 'radarChart') return '雷达图设置';
    if (projectKey == 'rankList') return '排行榜设置';
    if (projectKey == 'timeAxis') return '时间轴设置';
    if (projectKey == 'text') return '文本设置';
    if (projectKey == 'image') return '图片设置';
    if (projectKey == 'carousel') return '轮播图设置';
    if (projectKey == 'video') return '视频设置';
    if (projectKey == 'iframe') return 'iframe设置';
    if (projectKey == 'mapChart') return '地图设置';
    if (projectKey == 'todo') return '待办设置';
    if (projectKey == 'commonFunc') return '常用功能设置';
    if (projectKey == 'dataBoard') return '数据面板设置';
  }
  function getTipLabel() {
    const projectKey = props.activeData.projectKey;
    if (projectKey == 'barChart') return 'APP不支持背景类型，默认显示基础类型';
    if (projectKey == 'lineChart') return 'APP不支持堆叠类型，默认显示基础类型';
    if (projectKey == 'mapChart') return 'APP不支持柱形和柱形排名类型，默认显示散点类型';
    return '';
  }
  function onStyleTypeChange(val) {
    const projectKey = props.activeData.projectKey;
    if (projectKey == 'image' || projectKey == 'video') {
  ...
  function initData() {
    state.fileList = [];
    if (props.activeData.projectKey == 'video' && props.activeData.option.defaultValue && props.activeData.option.styleType == 1) {
  ...
  function textChange() {
    props.activeData.option.defaultValue = '';
    if (props.activeData.dataType == 'static') props.activeData.option.defaultValue = 'LINZEN快速开发平台';
  }
