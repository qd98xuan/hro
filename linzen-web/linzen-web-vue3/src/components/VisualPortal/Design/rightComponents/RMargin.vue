<template>
  <a-collapse-panel>
    ...
    <template v-if="activeData.projectKey == 'pieChart' || activeData.projectKey == 'mapChart'">
    ...
    <template v-else-if="activeData.projectKey == 'radarChart'">
      <a-form-item label="上下边距">
...
<script lang="ts" setup>
  ...
  function getTitle() {
    ...
    if (projectKey == 'pieChart' || projectKey == 'radarChart' || projectKey == 'mapChart') return '中心坐标设置';
    return '坐标轴边距设置';
  }
</script>
