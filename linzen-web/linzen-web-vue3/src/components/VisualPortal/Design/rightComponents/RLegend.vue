  ...
  <a-collapse-panel>
    ...
    <template v-if="activeData.option.legendShow && showType == 'pc'">
      <a-form-item label="字体大小">
        <a-input-number v-model:value="activeData.option.legendTextStyleFontSize" :min="12" :max="25" />
      </a-form-item>
      <a-form-item label="布局">
        <linzen-radio v-model:value="activeData.option.legendOrient" :options="layoutList" optionType="button" button-style="solid" class="right-radio" />
      </a-form-item>
