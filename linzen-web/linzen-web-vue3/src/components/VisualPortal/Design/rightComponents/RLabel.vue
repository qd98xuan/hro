<template>
  <a-collapse-panel>
    ...
    <template v-if="activeData.option.seriesLabelShow">
      <template v-if="activeData.projectKey == 'pieChart' && showType == 'pc'">
      ...
      <template v-if="showType == 'pc'">
        <a-form-item label="字体大小">
          <a-input-number v-model:value="activeData.option.seriesLabelFontSize" :min="12" :max="25" />
        </a-form-item>
      ...
      <a-form-item label="字体颜色">
        <linzen-color-picker v-model:value="activeData.option.seriesLabelColor" size="small" />
      </a-form-item>
      <a-form-item label="背景色" v-if="showType == 'pc'">
        <linzen-color-picker v-model:value="activeData.option.seriesLabelBgColor" size="small" />
      </a-form-item>
    </template>
  </a-collapse-panel>
</template>
