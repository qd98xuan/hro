    ...
    <template v-if="activeData.option.tooltipShow">
      <template v-if="showType == 'pc'">
        <a-form-item label="字体大小">
          <a-input-number v-model:value="activeData.option.tooltipTextStyleFontSize" :min="12" :max="25" />
        </a-form-item>
      ...
      <a-form-item label="字体颜色">
        <linzen-color-picker v-model:value="activeData.option.tooltipTextStyleColor" size="small" />
      </a-form-item>
      <a-form-item label="背景色">
        <linzen-color-picker v-model:value="activeData.option.tooltipBgColor" size="small" />
      </a-form-item>
    </template>
  </a-collapse-panel>
</template>
