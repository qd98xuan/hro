const dataBoardDefault = [
  {
    ...
    num: 262,
    field: '',
    icon: 'icon-linzen icon-linzen-wf-contractApproval',
  ...
  },
  {
    ...
    num: 199,
    field: '',
    icon: 'icon-linzen icon-linzen-wf-outgoingApply',
  ...
  },
  {
    ...
    num: 126263.5,
    field: '',
    icon: 'icon-linzen icon-linzen-wf-payDistribution',
  ...
  },
  {
    ...
    num: 6223.2,
    field: '',
    icon: 'icon-linzen icon-linzen-wf-incomeRecognition',
...
export const layoutComponents = [
  {
    icon: 'icon-linzen icon-linzen-portal-card',
    label: '卡片面板',
    projectKey: 'card',
    title: '卡片面板',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-card',
  ...
  {
    icon: 'icon-linzen icon-linzen-portal-tab',
    label: '标签面板',
    projectKey: 'tab',
    title: '标签面板',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-tab',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
...
export const systemComponents = [
  {
    icon: 'icon-linzen icon-linzen-generator-notice',
    label: '公告通知',
    projectKey: 'notice',
    title: '公告通知',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-notice',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  // {
  //   icon: 'icon-linzen icon-linzen-generator-email',
  //   label: '未读邮件',
  //   projectKey: 'email',
  //   title: '未读邮件',
  //   visibility: ['pc', 'app'],
  ...
  //     titleLeft: 'left',
  //     titleBgColor: '',
  //     cardIcon: 'icon-linzen icon-linzen-generator-email',
  //     cardIconColor: '#606266',
  //     linkType: '',
  //     type: '',
  //     moduleId: '',
  ...
  // },
  {
    icon: 'icon-linzen icon-linzen-generator-todolist',
    label: '待办事项',
    projectKey: 'todoList',
    title: '待办事项',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-todolist',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
...
export const basicComponents = [
  {
    icon: 'icon-linzen icon-linzen-generator-todo',
    label: '我的待办',
    projectKey: 'todo',
    title: '我的待办',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-todo',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
      ...
      defaultValue: [
        {
          ...
          icon: 'icon-linzen icon-linzen-flowTodo',
          iconBgColor: '#f68900',
          type: 2,
        },
        {
          ...
          icon: 'icon-linzen icon-linzen-flowDone',
          iconBgColor: '#7b1ae1',
          type: 2,
        },
        {
          ...
          icon: 'icon-linzen icon-linzen-flowForm',
          iconBgColor: '#33b932',
          type: 2,
        },
      ],
  ...
  {
    icon: 'icon-linzen icon-linzen-generator-function',
    label: '常用功能',
    projectKey: 'commonFunc',
    title: '常用功能',
    renderKey: '',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-function',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
      ...
      defaultValue: [
        {
          ...
          icon: 'icon-linzen icon-linzen-webDesign',
          iconBgColor: '#FF3B3B',
          type: 2,
          id: '1',
        },
        {
          ...
          icon: 'icon-linzen icon-linzen-flowDesign',
          iconBgColor: '#7B1AE1',
          type: 2,
          id: '2',
        },
        {
          ...
          icon: 'icon-linzen icon-linzen-authorize',
          iconBgColor: '#1890FF',
          type: 2,
          id: '3',
        },
        {
          ...
          icon: 'icon-linzen icon-linzen-reportDesign',
          iconBgColor: '#F68900',
          type: 2,
          id: '4',
        },
        {
          ...
          icon: 'icon-linzen icon-linzen-portalDesign',
          iconBgColor: '#33B932',
          type: 2,
          id: '5',
        },
      ...
      appDefaultValue: [
        {
          ...
          moduleId: '',
          linkType: '2',
          urlAddress: 'https://www.linzensoft.com/',
          linkTarget: '_blank',
          icon: 'icon-linzen icon-linzen-webDesign',
          iconBgColor: '#33B932',
          type: 2,
  ...
  {
    icon: 'icon-linzen icon-linzen-generator-Panel',
    label: '数据面板',
  ...
  {
    icon: 'icon-linzen icon-linzen-generator-table',
    label: '表格列表',
    projectKey: 'tableList',
    title: '表格列表',
    dataType: 'static',
    propsApi: '',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-table',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-generator-textarea',
    label: '文本',
    projectKey: 'text',
    title: '文本',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-textarea',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-portal-image',
    label: '图片',
    projectKey: 'image',
    title: '图片',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-image',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-portal-carousel',
    label: '轮播图',
    projectKey: 'carousel',
    title: '轮播图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-carousel',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
    ...
    option: {
      ...
      defaultValue: [
        {
          imageUrl: 'https://app.cdn.linzensoft.com/image/3.2/banner1.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
        ...
        {
          imageUrl: 'https://app.cdn.linzensoft.com/image/3.2/banner2.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
        ...
        {
          imageUrl: 'https://app.cdn.linzensoft.com/image/3.2/banner4.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-portal-video',
    label: '视频',
    projectKey: 'video',
    title: '视频',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-video',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-portal-schedule',
    label: '日程',
    projectKey: 'schedule',
    title: '日程',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-schedule',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-portal-iframe',
    label: 'iframe',
    projectKey: 'iframe',
    title: 'iframe',
    visibility: ['pc'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-iframe',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
    ...
    option: {
      defaultValue: 'https://www.linzensoft.com/',
    },
    w: 12,
    h: 8,
    minW: 4,
...
export const chartComponents = [
  {
    icon: 'icon-linzen icon-linzen-generator-bar',
    label: '柱状图',
    projectKey: 'barChart',
    title: '柱状图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-bar',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-generator-pie',
    label: '饼图',
    projectKey: 'pieChart',
    title: '饼图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-pie',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-generator-line',
    label: '折线图',
    projectKey: 'lineChart',
    title: '折线图',
    renderKey: '',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-line',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-generator-radar', //'icon-linzen icon-linzen-generator-annular',
    label: '雷达图',
    projectKey: 'radarChart',
    title: '雷达图',
    renderKey: '',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-radar',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-generator-area',
    label: '地图',
    projectKey: 'mapChart',
    title: '地图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-generator-area',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-portal-rankList',
    label: '排行榜',
    projectKey: 'rankList',
    title: '排行榜',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-rankList',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-linzen icon-linzen-portal-timeAxis',
    label: '时间轴',
    projectKey: 'timeAxis',
    title: '时间轴',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-linzen icon-linzen-portal-timeAxis',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
