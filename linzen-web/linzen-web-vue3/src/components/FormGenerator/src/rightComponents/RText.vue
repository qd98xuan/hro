<template>
  ...
  <a-form-item label="对齐方式">
    <linzen-radio v-model:value="activeData.textStyle['text-align']" :options="alignOptions" optionType="button" button-style="solid" class="right-radio" />
  </a-form-item>
  <a-form-item label="字体颜色">
    <linzen-color-picker v-model:value="activeData.textStyle['color']" size="small" />
  </a-form-item>
