<template>
    ...
    <a-form-item label="类型">
      ...
      <div class="mt-10px">
        ...
        <template v-else-if="activeData.__config__.startTimeType == 2">
          <linzen-select v-model:value="activeData.__config__.startRelationField" placeholder="请选择关联时间选择" :options="formFieldsOptions" />
        </template>
  ...
  <template v-if="activeData.__config__.endTimeRule">
    <a-form-item label="类型">
      <linzen-select v-model:value="activeData.__config__.endTimeType" placeholder="请选择" :options="typeOptions" @change="onEndTimeTypeChange" />
      <div class="mt-10px">
        ...
        <template v-else-if="activeData.__config__.endTimeType == 2">
          <linzen-select v-model:value="activeData.__config__.endRelationField" placeholder="请选择关联时间选择" :options="formFieldsOptions" />
        </template>
...
<script lang="ts" setup>
  ...
  const formFieldsOptions = computed(() => {
    ...
    const loop = (data, parent?) => {
      ...
      if (data.__vModel__ && data.__config__.projectKey === 'timePicker' && data.__vModel__ !== props.activeData.__vModel__) {
