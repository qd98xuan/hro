<template>
  <a-form-item label="弹窗标题" v-if="projectKey === 'popupSelect'">
    <a-input v-model:value="activeData.popupTitle" placeholder="请输入" />
  </a-form-item>
  <a-form-item label="弹窗类型" v-if="projectKey === 'popupSelect' && showType === 'pc'">
    <linzen-select v-model:value="activeData.popupType" placeholder="请选择" :options="popupTypeOptions" />
  </a-form-item>
  <a-form-item label="弹窗宽度" v-if="projectKey === 'popupSelect' && showType === 'pc'">
  ...
  <a-form-item v-if="projectKey === 'popupSelect' && (modelType == 1 || modelType == 6)">
