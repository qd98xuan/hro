...
export const getRealProps = (data, projectKey) => {
...
export const getFormSchemaItem = data => {
  const item = getRealProps(data, data.__config__.projectKey);
  ...
  const schema = {
    ...
    component: upperFirst(item.__config__.projectKey),
    componentProps,
