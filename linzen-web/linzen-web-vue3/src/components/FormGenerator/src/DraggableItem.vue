    ...
    setup(props, { attrs }) {
        ...
        tableSetting(element) {
          ...
          return [
            <span
              ...
              <i class="icon-linzen icon-linzen-generator-insertRow" />
            </span>,
            <span
              ...
              <i class="icon-linzen icon-linzen-generator-insertCol" />
            </span>,
          ];
        },
          ...
          return [
            <span class="drawing-item-cell">
              <a-dropdown
                ...
                <i class="icon-linzen icon-linzen-generator-TableSettings" />
              </a-dropdown>
            </span>,
          ];
        },
      ...
      const layouts = {
        colFormItem(element, index, parent) {
          ...
          if (config.projectKey == 'location') element.useAutoLocation = false;
          const Item =
            props.showType === 'app' && !useCompList.includes(config.projectKey) ? (
        ...
        rowFormItem(element, index, parent) {
          ...
          if (element.__config__.projectKey === 'tableGrid') {
          ...
          if (config.projectKey === 'row' || (props.showType === 'app' && config.projectKey === 'card')) {
            return (
              <a-col
                span={props.showType === 'app' ? 24 : config.span}
                data-draggable={true}
                ...
                <a-row class={className + ' drawing-row-item-row'}>
                  <span class="component-name">{config.projectKey === 'card' ? config.label : config.componentName}</span>
                  <a-col>
