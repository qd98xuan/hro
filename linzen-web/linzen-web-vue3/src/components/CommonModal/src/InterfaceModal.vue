      ...
      <div class="linzen-content-wrapper">
        ...
        <div class="linzen-content-wrapper-center">
          <div class="linzen-content-wrapper-content">
            <BasicTable @register="registerTable" :searchInfo="searchInfo" class="linzen-sub-table">
...
<script lang="ts" setup>
  ...
  const getSelectBindValue = computed(() => {
    return {
      ...
      placeholder: '请选择' + unref(props).popupTitle,
      open: false,
      showSearch: false,
      showArrow: true,
    };
  ...
  function handleTreeSelect(id) {
    ...
    searchInfo.hasPage = props.hasPage;
    getForm().resetFields();
  }
