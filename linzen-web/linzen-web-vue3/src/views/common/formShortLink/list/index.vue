<template>
  <div class="linzen-content-wrapper short-link-wrapper short-link-wrapper-list">
    ...
    <div class="short-link-main" v-show="!columnPassUse">
      <a-popover placement="bottomRight">
        ...
        <i class="linzen-custom linzen-custom-qrcode icon-qrcode"></i>
      </a-popover>
            ...
            <template #bodyCell="{ column, record }">
              ...
              <template v-if="!(record.top || column.id?.includes('-'))">
                <template v-if="column.projectKey === 'inputNumber'">
                  <linzen-input-number v-model:value="record[column.dataIndex]" :precision="column.precision" :thousands="column.thousands" disabled detailed />
                </template>
...
<script lang="ts" setup>
  ...
  import { getScriptFunc, thousandsFormat } from '/@/utils/linzen';
