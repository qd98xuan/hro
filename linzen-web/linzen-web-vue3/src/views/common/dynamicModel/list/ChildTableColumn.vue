    ...
    <template v-if="!expand">
      <tr v-for="(item, index) in fewData" class="child-table__row" :key="index">
        <td
          ...
          <div class="cell" v-if="headItem.projectKey === 'relationForm'">
          ...
          <div class="cell" v-else-if="headItem.projectKey === 'inputNumber'">
            <linzen-input-number v-model:value="item[headItem.dataIndex]" :precision="headItem.precision" :thousands="headItem.thousands" disabled detailed />
          </div>
          <div class="cell" v-else-if="headItem.projectKey === 'calculate'">
            <linzen-calculate
          ...
          <div class="cell" v-else-if="headItem.projectKey === 'sign'">
            <linzen-sign v-model:value="item[headItem.dataIndex]" detailed />
          </div>
          <div class="cell" v-else-if="headItem.projectKey === 'rate'">
            <linzen-rate v-model:value="item[headItem.dataIndex]" :count="headItem.count" :allowHalf="headItem.allowHalf" disabled />
          </div>
          <div class="cell" v-else-if="headItem.projectKey === 'slider'">
            <linzen-slider v-model:value="item[headItem.dataIndex]" :min="headItem.min" :max="headItem.max" :step="headItem.step" disabled />
          </div>
          <div class="cell" v-else-if="headItem.projectKey === 'uploadImg'">
            <linzen-upload-img v-model:value="item[headItem.dataIndex]" disabled detailed simple v-if="item[headItem.dataIndex]?.length" />
          </div>
          <div class="cell" v-else-if="headItem.projectKey === 'uploadFile'">
            <linzen-upload-file v-model:value="item[headItem.dataIndex]" disabled detailed simple v-if="item[headItem.dataIndex]?.length" />
          </div>
          <div class="cell" v-else-if="headItem.projectKey === 'input'">
            <linzen-input
              v-model:value="item[headItem.dataIndex]"
