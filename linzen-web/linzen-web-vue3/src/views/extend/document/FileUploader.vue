        ...
        <template #default="{ fileList }">
          <div class="file-panel">
            <div class="file-title">
              ...
              <div class="operate">
                <i class="icon-linzen icon-linzen-nav-close" @click="onComplete"></i>
              </div>
            </div>
            <div class="upload-file-list">
              ...
              <linzen-empty description="暂无待上传文件" v-if="!fileList.length" />
            </div>
          </div>
        </template>
      </uploader-list>
...
<script lang="ts" setup>
  ...
  import FileItem from '/@/components/Linzen/Upload/src/SimpleUploader/FileItem.vue';
