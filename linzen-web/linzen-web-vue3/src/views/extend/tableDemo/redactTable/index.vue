          ...
          <template #bodyCell="{ column, record, index }">
            ...
            <template v-else>
              <template v-if="state.tabClickId == record.id">
                <linzen-date-picker v-if="column.key === 'interactionDate'" v-model:value="record[column.key]" format="YYYY-MM-DD" allowClear />
                ...
                <linzen-select v-else-if="column.key === 'projectType'" v-model:value="record[column.key]" :options="state.industryTypeList" />
