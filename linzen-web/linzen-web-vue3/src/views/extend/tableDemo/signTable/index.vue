            ...
            <template v-if="column.key === 'signArray'">
              <template v-if="record.signArray?.length">
                <span v-for="(item, i) in record.signArray" :key="i">
                  <i class="linzen-custom linzen-custom-checkbox-blank-circle" style="color: #ff625c; font-size: 16px" v-if="item == '1'"></i>
                  <i class="linzen-custom linzen-custom-checkbox-blank-circle" style="color: #f9a646; font-size: 16px" v-if="item == '2'"></i>
                  <i class="linzen-custom linzen-custom-checkbox-blank-circle" style="color: #f4ce4a; font-size: 16px" v-if="item == '3'"></i>
                  <i class="linzen-custom linzen-custom-checkbox-blank-circle" style="color: #6dcc51; font-size: 16px" v-if="item == '4'"></i>
                  <i class="linzen-custom linzen-custom-checkbox-blank-circle" style="color: #4bb8f3; font-size: 16px" v-if="item == '5'"></i>
                  <i class="linzen-custom linzen-custom-checkbox-blank-circle" style="color: #d088e1; font-size: 16px" v-if="item == '6'"></i>
                  <i class="linzen-custom linzen-custom-checkbox-blank-circle" style="color: #a5a5a8; font-size: 16px" v-if="item == '7'"></i>
                </span>
              </template>
              <i class="linzen-custom linzen-custom-checkbox-blank-circle-outline" v-else style="font-size: 16px; color: #cecece"></i>
            </template>
