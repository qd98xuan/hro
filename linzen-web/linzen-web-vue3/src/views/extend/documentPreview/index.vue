<template>
  <div class="linzen-content-wrapper documentPreview-wrapper">
    <div class="linzen-content-wrapper-center">
      ...
      <div class="linzen-content-wrapper-content bg-white">
        <a-tabs v-model:activeKey="activeKey" type="card" class="linzen-content-wrapper-tabs" destroyInactiveTabPane>
        ...
        <div class="p-10px">
          ...
          <a-alert message="免责声明：永中文档预览组件不属于LINZEN产品，只用于介绍第三方组件如何在《LINZEN快速开发平台》中使用。" type="warning" show-icon v-else />
        </div>
...
<style lang="less" scoped>
  .documentPreview-wrapper {
    &.linzen-content-wrapper .linzen-content-wrapper-center .linzen-content-wrapper-content {
      .linzen-content-wrapper-tabs.ant-tabs-card {
        height: auto;
      }
    }
  }
