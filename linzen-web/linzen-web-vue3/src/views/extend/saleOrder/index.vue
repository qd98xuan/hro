<template>
  <div class="linzen-content-wrapper h-full">
    <div class="linzen-content-wrapper-center">
      <div class="sale-order-content">
        <BasicTable @register="registerTable" @row-click="handleRowClick">
          <template #tableTitle>
            <a-button type="primary" preIcon="icon-linzen icon-linzen-btn-add" @click="handleAdd()">{{ t('common.addText') }}</a-button>
            <a-button type="link" preIcon="icon-linzen icon-linzen-btn-edit" @click="handleUpdate()">{{ t('common.editText') }}</a-button>
            <a-button type="link" preIcon="icon-linzen icon-linzen-delete" @click="handleDel()">{{ t('common.delText') }}</a-button>
