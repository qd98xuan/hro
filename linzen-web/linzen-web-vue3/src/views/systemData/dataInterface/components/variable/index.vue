<template>
  <BasicPopup v-bind="$attrs" @register="registerPopup" title="提取变量" class="full-popup">
    <div class="linzen-content-wrapper-search-box pl-10px mt-10px">
    ...
    <BasicTable @register="registerTable" :columns="menuTableColumns" :searchInfo="getSearchInfo">
      <template #tableTitle>
        ...
        <linzen-upload-btn url="/api/system/DataInterfaceVariate/Actions/Import" accept=".ffa" @on-success="reload"></linzen-upload-btn>
      </template>
...
<style lang="less" scoped>
  .linzen-content-wrapper-search-box {
