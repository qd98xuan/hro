      ...
      <div class="linzen-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <linzen-upload-btn :url="getUploadUrl" accept=".bdb" @on-success="reload"></linzen-upload-btn>
            <a-button type="link" preIcon="icon-linzen icon-linzen-btn-common" @click="handleFieldManage()">常用字段</a-button>
          </template>
