  ...
  <div class="linzen-content-wrapper">
    <div class="linzen-content-wrapper-center">
      ...
      <div class="linzen-content-wrapper-content bg-white">
        <a-tabs v-model:activeKey="activeKey" type="card" class="linzen-content-wrapper-tabs" destroyInactiveTabPane @tabClick="onTabClick">
          <a-tab-pane key="0" tab="委托发起">
            <BasicTable @register="registerLaunchTable" :searchInfo="getSearchInfo">
              <template #tableTitle>
                <a-button type="primary" preIcon="icon-linzen icon-linzen-btn-add" @click="openAddModal()">发起委托</a-button>
              </template>
