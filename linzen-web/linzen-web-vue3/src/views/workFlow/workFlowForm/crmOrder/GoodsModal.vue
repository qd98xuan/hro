<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="选择商品" @ok="handleSubmit" :width="800" class="linzen-list-modal">
    <BasicTable @register="registerTable" class="linzen-sub-table"></BasicTable>
  </BasicModal>
</template>
