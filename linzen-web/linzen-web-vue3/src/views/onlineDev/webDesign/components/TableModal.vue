<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="数据选择" @ok="handleSubmit" :width="800" class="linzen-list-modal">
    <BasicTable :searchInfo="searchInfo" @register="registerTable" class="linzen-sub-table"></BasicTable>
  </BasicModal>
</template>
<script lang="ts" setup>
  ...
  function handleSubmit() {
    ...
    console.info(selectedData, JSON.stringify(selectedData));
