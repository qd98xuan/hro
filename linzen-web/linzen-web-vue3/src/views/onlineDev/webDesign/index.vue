    ...
    <div class="linzen-content-wrapper-center">
      <div class="linzen-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            <a-button type="primary" preIcon="icon-linzen icon-linzen-btn-add" @click="openAddModal()">{{ t('common.addText') }}</a-button>
            <linzen-upload-btn url="/api/visualdev/OnlineDev/Actions/Import" accept=".vdd" @on-success="reload"></linzen-upload-btn>
          </template>
