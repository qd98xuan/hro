        ...
        <BasicTable @register="registerTable">
          <template #toolbar>
            <a-tooltip placement="top">
              ...
              <i class="icon-linzen icon-linzen-generator-slider cursor-pointer text-18px" @click="openDrawer(true)"></i>
            </a-tooltip>
          </template>
          <template #tableTitle>
            <a-dropdown>
              ...
              <a-button type="primary" preIcon="icon-linzen icon-linzen-btn-add">{{ t('common.addText') }}<DownOutlined /></a-button>
            </a-dropdown>
            <linzen-upload-btn url="/api/visualdev/Integrate/Actions/Import" accept=".bi" @on-success="reload"></linzen-upload-btn>
          </template>
...
<script lang="ts" setup>
  ...
  const columns: BasicColumn[] = [
    ...
    { title: '最后修改时间', dataIndex: 'updateTime', width: 150, format: 'date|YYYY-MM-DD HH:mm:ss' },
