      ...
      <div class="linzen-content-wrapper-content">
        <BasicTable @register="registerTable" :searchInfo="searchInfo" ref="tableRef">
          <template #tableTitle>
            ...
            <a-button type="link" @click="handleExport"><i class="icon-linzen icon-linzen-btn-download button-preIcon"></i>{{ t('common.exportText') }}</a-button>
            <a-button type="link" @click="handleImport"><i class="icon-linzen icon-linzen-btn-upload button-preIcon"></i>{{ t('common.importText') }}</a-button>
            <a-button type="link" @click="handleSync"><i class="icon-linzen icon-linzen-synForThird button-preIcon"></i>{{ t('common.syncText') }}</a-button>
          </template>
