<template>
  <div class="linzen-content-wrapper message-record-wrapper">
    <div class="linzen-content-wrapper-center">
      ...
      <div class="linzen-content-wrapper-content bg-white">
        ...
        <BasicTable @register="registerTable" :columns="columns" :searchInfo="getSearchInfo">
          <template #tableTitle>
            <a-button type="error" preIcon="icon-linzen icon-linzen-btn-clearn" @click="handleDelete">{{ t('common.delText') }}</a-button>
          </template>
