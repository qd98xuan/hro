<template>
  <div class="linzen-content-wrapper">
    <div class="linzen-content-wrapper-center bg-white">
      <a-form :colon="false" labelAlign="right" :labelCol="{ style: { width: '100px' } }" class="right-board-form h-full">
        <a-tabs class="linzen-content-wrapper-tabs" v-model:activeKey="activeKey" type="card">
          <a-tab-pane :key="1" tab="基本设置" class="p-30px">
            <a-row>
              <a-col :span="24">
                <a-form-item label="系统图标">
                  <div class="img-list">
                    <LinzenUploadImgSingle v-model:value="baseForm.loginIcon" tipText="登录图标" />
                    <LinzenUploadImgSingle v-model:value="baseForm.logoIcon" tipText="LOGO图标" />
                    <LinzenUploadImgSingle v-model:value="baseForm.appIcon" tipText="APP图标" />
                  </div>
                </a-form-item>
              </a-col>
              <a-col :span="24">
                <a-form-item label="系统标题">
                  <a-input v-model:value="baseForm.title" placeholder="系统标题" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="系统名称">
                  <a-input v-model:value="baseForm.sysName" placeholder="系统名称" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="12">
              ...
              <a-col :span="12">
                <a-form-item label="公司名称">
                  <a-input v-model:value="baseForm.companyName" placeholder="公司名称" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="版权信息">
                  <a-input v-model:value="baseForm.copyright" placeholder="版权信息" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="公司简称">
                  <a-input v-model:value="baseForm.companyCode" placeholder="公司简称" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="公司地址">
                  <a-input v-model:value="baseForm.companyAddress" placeholder="公司地址" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="公司法人">
                  <a-input v-model:value="baseForm.companyContacts" placeholder="公司法人" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="公司电话">
                  <a-input v-model:value="baseForm.companyTelePhone" placeholder="公司电话" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="公司邮箱">
                  <a-input v-model:value="baseForm.companyEmail" placeholder="公司电话" allowClear />
                </a-form-item>
              </a-col>
              <a-col :span="24">
                <a-form-item label="系统描述">
                  <a-textarea v-model:value="baseForm.sysDescription" :autoSize="{ minRows: 5, maxRows: 10 }" placeholder="系统描述" />
                </a-form-item>
              </a-col>
              <a-form-item label=" ">
            ...
            <a-tabs v-model:activeKey="thirdTab" tab-position="left" style="height: 100%">
              <a-tab-pane :key="1" tab="登录策略">
                <a-row>
                  <a-col :span="8">
                    <a-form-item label="登录方式">
                      <linzen-select v-model:value="baseForm.singleLogin" placeholder="请选择" :options="singleLoginOptions" />
                    </a-form-item>
                ...
                <a-row class="mt-10px">
                  <a-col :span="10">
                    <a-form-item label=" ">
                      <linzen-radio v-model:value="baseForm.lockType" :options="lockTypeOptions" />
                      <div class="mt-10px">
                ...
                <a-row>
                  <a-col :span="8">
                    <a-form-item label="登录验证码">
                      <linzen-switch v-model:value="baseForm.enableVerificationCode" />
                    </a-form-item>
                    ...
                    <a-form-item label="登录提示语">
                      <linzen-switch v-model:value="baseForm.lastLoginTimeSwitch" />
                    </a-form-item>
                    <a-form-item v-if="baseForm.lastLoginTimeSwitch" label=" ">
                      <a-card size="small" style="width: 300px" :body-style="{ padding: '0px 20px' }">
                        ...
                        <template #extra>
                          <i class="icon-linzen icon-linzen-nav-close card-extra" />
                        </template>
                        <div class="card-item">
                    ...
                    <a-form-item label="白名单验证">
                      <linzen-switch v-model:value="baseForm.whitelistSwitch" />
                    </a-form-item>
                  </a-col>
                </a-row>
                <a-row>
                ...
                <a-row>
                  <a-col :span="8">
                    <a-form-item label="密码定期更新" :labelCol="{ style: { width: '120px' } }">
                      <linzen-switch v-model:value="baseForm.passwordIsUpdatedRegularly" />
                    </a-form-item>
                    ...
                    <a-form-item label="密码强度限制" :labelCol="{ style: { width: '120px' } }">
                      <linzen-switch v-model:value="baseForm.passwordStrengthLimit" />
                    </a-form-item>
                  </a-col>
                </a-row>
                <a-row>
                  <a-col :span="10">
                    <a-form-item label=" " v-if="baseForm.passwordStrengthLimit" :labelCol="{ style: { width: '120px' } }">
                      <div class="flex">
                        <LinzenCheckboxSingle class="checkbox mr-20px" label="最小长度" v-model:value="baseForm.passwordLengthMin" />
                        <a-input-number
                      ...
                      <LinzenCheckboxSingle class="checkbox" label="包含数字" v-model:value="baseForm.containsNumbers" /><br />
                      <LinzenCheckboxSingle class="checkbox" label="包含小写字母" v-model:value="baseForm.includeLowercaseLetters" /><br />
                      <LinzenCheckboxSingle class="checkbox" label="包含大写字母" v-model:value="baseForm.includeUppercaseLetters" /><br />
                      <LinzenCheckboxSingle class="checkbox" label="包含字符" v-model:value="baseForm.containsCharacters" />
                    </a-form-item>
                  </a-col>
                </a-row>
                <a-row>
                  <a-col :span="8">
                    <a-form-item label="禁用旧密码" :labelCol="{ style: { width: '120px' } }">
                      <linzen-switch v-model:value="baseForm.disableOldPassword" />
                    </a-form-item>
                    ...
                    <a-form-item label="修改初始密码提醒" :labelCol="{ style: { width: '120px' } }">
                      <linzen-switch v-model:value="baseForm.mandatoryModificationOfInitialPassword" />
                    </a-form-item>
            ...
            <a-row>
              <a-col :span="12">
                <a-form-item label="超级管理员">
                  <linzen-user-select v-model:value="adminIds" placeholder="请选择" multiple />
                </a-form-item>
                <a-form-item label=" ">
            ...
            <a-row>
              <a-col :span="8">
                ...
                <a-form-item :labelCol="{ style: { width: '120px' } }">
                  ...
                  <linzen-switch v-model:value="baseForm.isClick" />
                </a-form-item>
    ...
    <BasicModal v-bind="$attrs" @register="registerModal" title="数据同步" :footer="null" :width="450" class="sync-dialog">
      <div class="add-item">
        <i class="add-icon syn-icon icon-linzen icon-linzen-upload"></i>
        <div class="add-txt">
      ...
      <div class="add-item ding-item">
        <i class="add-icons syn-icon icon-linzen icon-linzen-download"></i>
        <div class="add-txt">
