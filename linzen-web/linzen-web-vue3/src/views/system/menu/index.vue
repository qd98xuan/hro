...
<script lang="ts" setup>
  ...
  const columns: BasicColumn[] = [
    { title: t('common.system.menu.fullName'), dataIndex: 'fullName', width: 200 },
    { title: t('common.system.menu.enCode'), dataIndex: 'enCode', width: 200 },
    { title: t('common.system.menu.description'), dataIndex: 'description' },
    { title: t('common.system.menu.icon'), dataIndex: 'icon', width: 50, align: 'center' },
    { title: t('common.system.menu.sortCode'), dataIndex: 'sortCode', width: 70, align: 'center' },
    { title: t('common.system.menu.enabledMark'), dataIndex: 'enabledMark', width: 70, align: 'center' },
  ];
