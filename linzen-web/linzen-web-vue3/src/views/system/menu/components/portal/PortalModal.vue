<template>
  <div class="common-container">
    ...
    <a-modal v-model:visible="visible" title="选择门户" :width="800" class="linzen-list-modal" @ok="handleSubmit" @cancel="handleCancel">
      <template #closeIcon>
      ...
      <div class="linzen-content-wrapper">
        <div class="linzen-content-wrapper-center">
          <div class="linzen-content-wrapper-content">
            <BasicTable @register="registerTable" :searchInfo="searchInfo" class="linzen-sub-table"></BasicTable>
          </div>
        </div>
      </div>
    </a-modal>
