  ...
  <Dropdown placement="bottom" :overlayClassName="`${prefixCls}-dropdown-overlay`">
    ...
    <template #overlay>
      <Menu @click="handleMenuClick">
        <MenuItem key="profile" :text="t('layout.header.profile')" icon="icon-linzen icon-linzen-header-userInfo" />
<!--        <MenuItem key="feedBack" :text="t('layout.header.feedback')" icon="icon-linzen icon-linzen-header-feedBack" />-->
<!--        <MenuItem key="about" :text="t('layout.header.about')" icon="icon-linzen icon-linzen-header-about" />-->
<!--        <MenuItem key="statement" :text="t('layout.header.statement')" icon="icon-linzen icon-linzen-generator-card" />-->
        <MenuItem key="lock" :text="t('layout.header.tooltipLock')" icon="icon-linzen icon-linzen-header-lockScreen" v-if="getUseLockPage" />
        <MenuDivider />
        <MenuItem key="logout" :text="t('layout.header.dropdownItemLoginOut')" icon="icon-linzen icon-linzen-header-loginOut" />
      </Menu>
    </template>
  </Dropdown>
