  ...
  children: [
    {
      ...
      meta: {
        ...
        defaultTitle: '首页',
        icon: 'icon-linzen icon-linzen-nav-home',
        affix: true,
      },
    },
    {
      ...
      meta: {
        ...
        defaultTitle: '站内消息',
        icon: 'icon-linzen icon-linzen-sysNotice',
      },
    },
    {
      path: '/profile',
      ...
      meta: {
        ...
        defaultTitle: '个人信息',
        icon: 'icon-linzen icon-linzen-user',
      },
    },
    {
      path: '/externalLink',
      ...
      meta: {
        ...
        defaultTitle: '链接',
        icon: 'icon-linzen icon-linzen-generator-link',
      },
    },
    {
      path: '/workFlowDetail',
      ...
      meta: {
        ...
        defaultTitle: '流程详情',
        icon: 'icon-linzen icon-linzen-workFlow',
      },
    },
    {
      path: '/emailDetail',
      ...
      meta: {
        ...
        defaultTitle: '查看邮件',
        icon: 'icon-linzen icon-linzen-emailExample',
      },
    },
    {
      path: '/previewModel',
      ...
      meta: {
        ...
        defaultTitle: '功能预览',
        icon: 'icon-linzen icon-linzen-btn-preview',
      },
    },
  ],
};
