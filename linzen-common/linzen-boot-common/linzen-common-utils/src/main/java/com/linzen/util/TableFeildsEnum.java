...
public enum TableFeildsEnum {
    ...
    TENANTID("f_tenant_id" , "租户id", "50","varchar" ,false,"NULL",false),
    VERSION("f_version" , "乐观锁", "20","int" ,false,"NULL",false),
    FLOWTASKID("f_flow_task_id" , "流程任务主键", "50","varchar" ,false,"NULL",false),
    FLOWID("f_flow_id" , "流程id", "50","varchar" ,false,"NULL",false),
    DEL_FLAG("f_del_flag" , "删除标志", "20","int" ,false,"NULL",false),
    DELETETIME("f_delete_time" , "删除时间", "0","datetime" ,false,"NULL",false),
    DELETEUSERID("f_delete_user_id" , "删除用户", "50","varchar" ,false,"NULL",false),
    FOREIGN("f_foreign_id" , "外键", "50","varchar" ,false,"NULL",false);
