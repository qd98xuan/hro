...
import com.linzen.util.text.StrFormatter;
    ...
    public static boolean matches(String str, String pattern) {
        ...
        do {
            ...
            if (!isEmpty(prefixPattern)) {
                remainingUrl = StringUtils.substringAfter(str, prefixPattern);
            }
            ...
            if (!isEmpty(suffixPattern)) {
                remainingUrl = StringUtils.substringAfter(str, suffixPattern);
            }
