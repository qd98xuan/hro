...
import com.linzen.constant.model.MCode;
...
public interface MsgCode {
    ...
    MCode FA025 = MSG("该组织内权限为空，组织切换失败！");
    MCode FA031 = MSG("该组织无本应用权限，切换失败");
    MCode FA026 = MSG("更新失败，关联组织不存在，请重新登录，或者刷新页面");
    MCode FA027 = MSG("该系统下菜单为空，系统切换失败");

    MCode FA028 = MSG("新增数据失败");
    MCode FA029 = MSG("修改数据失败");

    MCode FA030 = MSG("更新失败！已绑定用户，无法修改状态");
    ...
    MCode EXIST101 = MSG("名称重复，请重新输入");
    MCode EXIST102 = MSG("编码重复，请重新输入");
    ...
    MCode LOG006 = MSG("账号已被禁用");
    MCode LOG007 = MSG("账号已被删除");
    MCode LOG010 = MSG("此IP未在白名单中");
    MCode LOG011 = MSG("登录失败，用户暂未绑定角色");
    MCode LOG012 = MSG("账号已被锁定，请联系管理员解除锁定");

    /*======1-登录相关======*/
    MCode LOG101 = LOG("账号或密码错误");
    MCode LOG102 = LOG("账号有误，请重新输入");
    MCode LOG103 = LOG("请输入验证码");
    MCode LOG104 = LOG("验证码错误");
    MCode LOG107 = LOG("验证码已失效");
    MCode LOG105 = LOG("连接租户服务失败，请稍后再试");
    MCode LOG106 = LOG("短信验证码错误");
    MCode LOG108 = MSG("请等待{time}分钟后再进行登录，或联系管理员解除锁定");
    ...
    MCode LOG205 = LOG("重置密码成功");
    MCode LOG206 = LOG("重置密码失败");
    ...
    /*== 数据库连接问题 ==*/
    MCode DB301 = DB("数据库连接成功");
    MCode DB302 = DB("数据库连接失败");
