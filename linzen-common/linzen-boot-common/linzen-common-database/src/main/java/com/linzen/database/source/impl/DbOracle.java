...
public class DbOracle extends DbBase {
     ...
     * Oracle特殊添加数据连接方式
     */
    public Connection getOracleConn(DbLinkEntity dsd, String url) throws DataBaseException {
        String logonUser = "";
    ...
    private static Connection createOracleConn(String driver, String logonUser, String userName, String password, String url) throws DataBaseException {
