package com.linzen.database.datatype.sync.enums;

import com.linzen.constant.MsgCode;
import com.linzen.database.datatype.db.interfaces.DtInterface;
import com.linzen.database.datatype.sync.model.DtConvertModel;
...
public enum DtConvertEnum {
     ...
     */
    public static <T extends DtInterface> DtConvertModel<T> getConvertModel(T fromDtEnum) throws DataBaseException {
     ...
     * @throws DataBaseException ignore
     */
    private static DtConvertEnum choose(String dbType) throws DataBaseException {
