...
import com.linzen.database.model.dto.JdbcResult;
import com.linzen.database.model.dto.ModelDTO;
import com.linzen.database.model.dto.PrepSqlDTO;
import com.linzen.database.model.interfaces.JdbcCreUpDel;
...
public class JdbcUtil {
    ...
    private final static String SELECT_MAPPER = "com.linzen.database.mapper.JdbcMapper.getListSql";
    private final static String UPDATE_MAPPER = "com.linzen.database.mapper.JdbcMapper.updateSql";
    private final static String UPDATE_MAPPERS = "com.linzen.database.mapper.JdbcMapper.updatesSql";
    private final static String DELETE_MAPPER = "com.linzen.database.mapper.JdbcMapper.deleteSql";
    private final static String INSERT_MAPPER = "com.linzen.database.mapper.JdbcMapper.insertSql";
    ...
    public static Integer queryOneInt(PrepSqlDTO dto, String keyWord) throws Exception {
        ...
        if (map != null && map.size() > 0) {
            for (Map.Entry<String, Object> mapEntity : map.entrySet()) {
                if(mapEntity.getKey().equalsIgnoreCase(keyWord)){
                    return Integer.parseInt(String.valueOf(mapEntity.getValue()));
                }
            }
        }
        throw new DataBaseException(MsgCode.FA020.get());
    }
    ...
    public static JdbcResult<JdbcPageMod> queryPage(PrepSqlDTO dto, String sortType, Integer currentPage, Integer pageSize) throws Exception {
        ...
        return new JdbcResult<>((jdbcResult)-> {
            ...
            try {
                ...
                throw new DataBaseException("sql异常：" + selectSql);
            }
            return pageModel;
        });
    }
