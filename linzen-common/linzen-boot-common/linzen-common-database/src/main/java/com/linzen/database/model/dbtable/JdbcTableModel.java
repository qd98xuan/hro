package com.linzen.database.model.dbtable;

import com.linzen.constant.MsgCode;
import com.linzen.database.constant.RsColumnKeyConst;
import com.linzen.database.constant.RsTableKeyConst;
...
//        @Cleanup Connection conn = PrepSqlDTO.getConn(dbLinkEntity);
        ...
        if (rs.next()) {
            ...
            throw new DataBaseException(MsgCode.DB009.get() + "：" + table);
        }
    }
