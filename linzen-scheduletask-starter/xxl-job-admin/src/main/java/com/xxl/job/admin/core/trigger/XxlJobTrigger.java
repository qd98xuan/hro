...
public class XxlJobTrigger {
    ...
    public static void trigger(String jobId,
        ...
        if (timeTaskEntity != null) {
            ...
            if (contentNewModel != null && contentNewModel.getStartTime() != null && contentNewModel.getStartTime() > System.currentTimeMillis()) {
                logger.debug("任务未到开始时间，jobId={}", jobId);
                return;
            }
            if (contentNewModel != null && contentNewModel.getEndTime() != null && contentNewModel.getEndTime() < System.currentTimeMillis()) {
    ...
    private static void processTrigger(XxlJobGroup group, XxlJobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total){
        ...
        long time = glueUpdatetime.getTime();
