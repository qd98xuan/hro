...
public class JobScheduleHelper {
            ...
            public void run() {
                ...
                while (!scheduleThreadToStop) {
                    ...
                    try {
                        ...
                        List<XxlJobInfo> scheduleList = XxlJobAdminConfig.getAdminConfig().getXxlJobInfoService().scheduleJobQuery(nowTime + PRE_READ_MS, preReadCount);
    ...
    public static Date generateNextValidTime(XxlJobInfo jobInfo, Date fromTime) throws Exception {
        try {
            ...
            logger.warn(">>>>>>>>>>> xxl-job, scheduleConf is invalid for job: jobId={}, scheduleType={}, scheduleConf={}, msg={}",
